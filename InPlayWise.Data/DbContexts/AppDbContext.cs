...
namespace InPlayWiseData.Data
{
    public class AppDbContext : IdentityDbContext<ApplicationUser>
	{
		...
		public DbSet<PredictionAccuracy> PredictionAccuracies { get; set; }
		...
		public DbSet<TrialCard> TrialCards { get; set; }

		public DbSet<Accumulator> Accumulaters { get; set; }
		public DbSet<CompetionCategory> CompetionCategories { get; set; }

		public DbSet<PaymentRecord> PaymentRecords { get; set; }
		public DbSet<UserSession> UserSessions { get; set; }

		public DbSet<TopMessageEntity> TopMessages { get; set; }
		public DbSet<FavouriteLeagueStat> FavouriteLeagueStats { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			builder.Entity<CompetionCategory>()
				.HasMany(cc => cc.Competitions)
				.WithMany(cc => cc.CompetitionCategories);

			builder.Entity<LiveMatchModel>()
				 .HasOne(lm => lm.HomeTeam)
				 .WithMany(ht => ht.HomeLiveMatches)
				 .HasForeignKey(match => match.HomeTeamId)
				 .OnDelete(DeleteBehavior.Restrict);


			builder.Entity<LiveMatchModel>()
				.HasOne(lm => lm.AwayTeam)
				.WithMany(lm => lm.AwayLiveMatches)
				.HasForeignKey(match => match.AwayTeamId)
				.OnDelete(DeleteBehavior.Restrict);

			builder.Entity<LiveMatchModel>()
				.HasOne(lm => lm.Competition)
				.WithMany(comp => comp.LiveMatches)
				.HasForeignKey(lm => lm.CompetitionId)
				.OnDelete(DeleteBehavior.Restrict);
