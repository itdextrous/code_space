...
namespace InPlayWise.Data.Migrations
{
    ...
    [Migration("20240715130529_livematches07150635")]
    partial class livematches07150635
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InPlayWise.Data.SportsEntities.LiveMatchModel", b =>
                {
                    ...
                    b.HasIndex("AwayTeamId")
                        .IsUnique()
                        .HasFilter("[AwayTeamId] IS NOT NULL");

                    b.HasIndex("HomeTeamId")
                        .IsUnique()
                        .HasFilter("[HomeTeamId] IS NOT NULL");
            ...
            modelBuilder.Entity("InPlayWise.Data.SportsEntities.LiveMatchModel", b =>
                {
                    b.HasOne("InPlayWise.Data.Entities.SportsEntities.Team", "AwayTeam")
                        .WithOne("AwayLiveMatch")
                        .HasForeignKey("InPlayWise.Data.SportsEntities.LiveMatchModel", "AwayTeamId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("InPlayWise.Data.Entities.SportsEntities.Team", "HomeTeam")
                        .WithOne("HomeLiveMatch")
                        .HasForeignKey("InPlayWise.Data.SportsEntities.LiveMatchModel", "HomeTeamId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("InPlayWise.Data.Entities.SportsEntities.Team", b =>
                {
                    b.Navigation("AwayLiveMatch");

                    b.Navigation("CleverLabelsCounter");

                    b.Navigation("FavTeams");

                    b.Navigation("HomeLiveMatch");
