namespace InPlayWise.Data.Entities
{
	public class Insights
	{
		...
		//Live Match Insights
		public int LivePossession { get; set; }
		public int LiveDangerousAttackPercentage { get; set; }
		public int LiveShotsOnTargetPercentage { get; set; }
		public int LiveCorners { get; set; }


		//Historical Matches Insights
