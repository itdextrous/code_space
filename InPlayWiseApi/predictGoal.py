...
def make_prediction(input_data_json):
     ...
     feature_names = [
          'home_score', 'home_shots_on_target', 'home_shots_off_target', 'home_attacks',
     ...
     predict_proba=loaded_model.predict_proba(X_new)
...
def train_and_save_model(json_data, model_filename):
